(defproject grasp "0.1.0-SNAPSHOT"
  ...
  :cljsbuild {:builds
              [{:id "app"
                ...
                ;; :figwheel {:on-jsload "grasp.core/on-figwheel-reload"}

                :compiler {:main grasp.core
                           :asset-path "js/compiled/out"
                           :output-to "resources/public/js/compiled/grasp.js"
